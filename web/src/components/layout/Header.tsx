  ...
  return (
    <header className="sticky top-0 z-50 glass-strong">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          {accountId && isAuthenticated && (
            <>
              ...
              <Link
                href="/cabinet"
                className="relative text-sm text-slate-300 hover:text-white transition-colors duration-200 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-gradient-to-r after:from-purple-500 after:to-cyan-500 after:transition-all after:duration-300 hover:after:w-full"
              >
                Cabinet
                {unreadCount > 0 && (
      ...
      <nav className="md:hidden flex items-center justify-around border-t border-white/[0.06] py-2.5 text-xs">
        ...
        <Link href="/requests" className="flex flex-col items-center gap-1 text-slate-400 hover:text-white transition-colors">
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        {accountId && isAuthenticated && (
          <>
            ...
            <Link href="/cabinet" className="relative flex flex-col items-center gap-1 text-slate-400 hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
